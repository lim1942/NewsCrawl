...
class A_39jiankangwang_zixunpindao_shehuiwanxiangSpider(CrawlSpider):
    
    IR_SITENAME = '39健康网'
    CHANNAL_PATH  ='资讯频道_社会万象'
    DOCCHANNEL = '资讯频道_社会万象'
    name = 'a_39jiankangwang_zixunpindao_shehuiwanxiang'
    # allowed_domains = ['''']
    start_urls = ['http://news.39.net/shwx/']
    rules = (
    ...
    def __init__(self, test=False, *args, **kwargs):
        super(A_39jiankangwang_zixunpindao_shehuiwanxiangSpider, self).__init__(*args, **kwargs)
        self.test = test
...
if __name__ == '__main__':
    ...
    command = ['scrapy','crawl','a_39jiankangwang_zixunpindao_shehuiwanxiang','-a','test=True']
