...
class A_39jiankangwang_zixunpindao_keyanfaxianSpider(CrawlSpider):
    
    IR_SITENAME = '39健康网'
    CHANNAL_PATH  ='资讯频道_科研发现'
    DOCCHANNEL = '资讯频道_科研发现'
    name = 'a_39jiankangwang_zixunpindao_keyanfaxian'
    # allowed_domains = ['''']
    start_urls = ['http://news.39.net/kyfx/']
    rules = (
    ...
    def __init__(self, test=False, *args, **kwargs):
        super(A_39jiankangwang_zixunpindao_keyanfaxianSpider, self).__init__(*args, **kwargs)
        self.test = test
...
if __name__ == '__main__':
    ...
    command = ['scrapy','crawl','a_39jiankangwang_zixunpindao_keyanfaxian','-a','test=True']
