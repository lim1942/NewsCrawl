...
class A_39jiankangwang_zixunpindao_shipinanquanSpider(CrawlSpider):
    
    IR_SITENAME = '39健康网'
    CHANNAL_PATH  ='资讯频道_食品安全'
    DOCCHANNEL = '资讯频道_食品安全'
    name = 'a_39jiankangwang_zixunpindao_shipinanquan'
    # allowed_domains = ['''']
    start_urls = ['http://news.39.net/ysbj/ys/']
    rules = (
    ...
    def __init__(self, test=False, *args, **kwargs):
        super(A_39jiankangwang_zixunpindao_shipinanquanSpider, self).__init__(*args, **kwargs)
        self.test = test
...
if __name__ == '__main__':
    ...
    command = ['scrapy','crawl','a_39jiankangwang_zixunpindao_shipinanquan','-a','test=True']
