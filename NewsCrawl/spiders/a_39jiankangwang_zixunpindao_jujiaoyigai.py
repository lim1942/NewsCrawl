...
class A_39jiankangwang_zixunpindao_jujiaoyigaiSpider(CrawlSpider):
    
    IR_SITENAME = '39健康网'
    CHANNAL_PATH  ='资讯频道_聚焦医改'
    DOCCHANNEL = '资讯频道_聚焦医改'
    name = 'a_39jiankangwang_zixunpindao_jujiaoyigai'
    # allowed_domains = ['''']
    start_urls = ['http://news.39.net/jjyg/']
    rules = (
    ...
    def __init__(self, test=False, *args, **kwargs):
        super(A_39jiankangwang_zixunpindao_jujiaoyigaiSpider, self).__init__(*args, **kwargs)
        self.test = test
...
if __name__ == '__main__':
    ...
    command = ['scrapy','crawl','a_39jiankangwang_zixunpindao_jujiaoyigai','-a','test=True']
