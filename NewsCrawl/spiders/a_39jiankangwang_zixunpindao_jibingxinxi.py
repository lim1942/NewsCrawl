...
class A_39jiankangwang_zixunpindao_jibingxinxiSpider(CrawlSpider):
    
    IR_SITENAME = '39健康网'
    CHANNAL_PATH  ='资讯频道_疾病信息'
    DOCCHANNEL = '资讯频道_疾病信息'
    name = 'a_39jiankangwang_zixunpindao_jibingxinxi'
    # allowed_domains = ['''']
    start_urls = ['http://news.39.net/jbyw/']
    rules = (
    ...
    def __init__(self, test=False, *args, **kwargs):
        super(A_39jiankangwang_zixunpindao_jibingxinxiSpider, self).__init__(*args, **kwargs)
        self.test = test
...
if __name__ == '__main__':
    ...
    command = ['scrapy','crawl','a_39jiankangwang_zixunpindao_jibingxinxi','-a','test=True']
